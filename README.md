...
- Serves a simple webpage showing live DHT11 readings (temperature and humidity)
- The page updates every 2 seconds using AJAX fetch from /sensor endpoint


Important note about GPIO34
---------------------------
- GPIO34-39 on the ESP32 are INPUT-ONLY pins. DHT11 requires bidirectional signaling,
so it will NOT work on GPIO34. This code uses GPIO14 by default.
...
- DATA -> GPIO14
- GND -> GND
- Add a 10K pull-up resistor between DATA and VCC if not built-in.
